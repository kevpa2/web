const rutina = {
    ...
    4: { nombreDia: "Jueves - Piernas", ejercicios: [
        ...
        { nombre: "Peso muerto rumano", descripcion: "4 series de 10-12 repeticiones", explicacion: "Mantén las piernas ligeramente flexionadas y baja la barra." },
    ...
    6: { nombreDia: "Sábado - Cuerpo completo y antebrazo", ejercicios: [
        { nombre: "Dominadas", descripcion: "4 series de 8-10 repeticiones", explicacion: "Agarra la barra con palmas hacia afuera, sube hasta que la barbilla supere la barra." },
        { nombre: "Curl de muñeca con barra", descripcion: "3 series de 12-15 repeticiones", explicacion: "Sujeta la barra con las palmas hacia arriba y realiza flexión de muñeca." },
        { nombre: "Russian twists", descripcion: "3 series de 20 repeticiones", explicacion: "Sentado, rota el torso con las manos juntas, tocando el suelo a cada lado." }
    ]}
};
...
function cargarRutinaDia(dia) {
    ...
    contenedor.innerHTML = "";  // Limpia el contenedor antes de agregar nuevos ejercicios
